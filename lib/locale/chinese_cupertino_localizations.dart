...
class ChineseCupertinoLocalizations extends DefaultCupertinoLocalizations {
  ...
  @override
  String get selectAllButtonLabel => K.getTranslation('select_all');

  @override
  String get pasteButtonLabel => K.getTranslation('paste');

  @override
  String get copyButtonLabel => K.getTranslation('copy');

  @override
  String get cutButtonLabel => K.getTranslation('cut');
