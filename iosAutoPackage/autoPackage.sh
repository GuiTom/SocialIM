...
pro_path="/Users/chenchao/Desktop/work/cli-holley/ios/Runner.xcworkspace"
app_name="GamePark"
...
apple_id="1806235010@qq.com" # 不上传则不填
apple_pwd="zzpq-xpcs-nrmx-zuus" # 不上传则不填
############################ 参数配置 ###################################
...
ipa_path="${temp_path}/${ipa_dir}/${app_name}.ipa"
...
uploadAppStore()
{
    ...
    ${toolPath} -m upload -assetFile ${ipa_path} -u ${apple_id} -p ${apple_pwd} -asc_provider "Huarong Zhang" -v informational
