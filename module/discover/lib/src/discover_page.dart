...
import 'package:discover/src/model/discover_repository.dart';
...
import 'model/my_discover_repository.dart';
import 'widget/comment_edit_widget.dart';
import 'discover_submit_page.dart';
import 'locale/k.dart';

class DiscoverPage extends StatefulWidget with ReloadController {
  @override
  Future<bool> reload() {
    (key as GlobalKey<DiscoverPageState>)
        .currentState
        ?.refreshKey
        .currentState
        ?.show();
  ...
  static GlobalKey<State> globalKey = GlobalKey<DiscoverPageState>();
...
class DiscoverPageState extends State<DiscoverPage> with ContextMenuMixin {
  @override
  Future<bool> reload() {
    return Future(() => true);
  }
